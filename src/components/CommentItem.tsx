...
const CommentItem: React.FC<CommentItemProps> = ({
  ...
  const handleVote = (voteType: "upvote" | "downvote") => {
    ...
    setLocalUpvotes((prevUpvotes) => {
      if (isUpvote) {
        return currentVote === "upvote" ? prevUpvotes - 1 : prevUpvotes + 1;
      } else {
        return currentVote === "upvote" ? prevUpvotes - 1 : prevUpvotes;
      }
    });

    setLocalDownvotes((prevDownvotes) => {
      if (!isUpvote) {
        return currentVote === "downvote"
          ? prevDownvotes - 1
          : prevDownvotes + 1;
      } else {
        return currentVote === "downvote" ? prevDownvotes - 1 : prevDownvotes;
      }
    });
